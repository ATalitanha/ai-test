...
interface ConfirmModalProps {
  ...
  onCancel?: () => void; // تابع فراخوانی برای لغو (قدیمی)
  onClose?: () => void; // تابع فراخوانی برای لغو (جدید)
  onConfirm: () => void; // تابع فراخوانی برای تایید
  title?: string; // عنوان مودال
...
export const DeleteConfirmModal = ConfirmModal;
